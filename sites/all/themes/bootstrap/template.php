...
function bootstrap_preprocess_page(&$variables) {
  ...
  if($variables['page']['task_menu']['system_user-menu']) {
      $variables['page']['task_menu']['#theme_wrappers'] = FALSE;
      $variables['page']['task_menu']['#theme_wrappers'] =array('menu_tree__user_menu');
  }
  
  //Page Templates suggestions by content type
...
function bootstrap_menu_tree__primary(&$variables) {
  return '<ul class="nav sf-menu">' . $variables['tree'] . '</ul>';
}
...
function bootstrap_menu_tree__secondary(&$variables) {
  return '<ul class="menu nav pull-right task">' . $variables['tree'] . '</ul>';
}

/**
 * Bootstrap theme wrapper function for the Task User menu links
 */
