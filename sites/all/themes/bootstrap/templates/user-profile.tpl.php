...
?>
   <div><?php //print render($user_profile['profile_member_info']['view']['profile2'][25]['#entity']->field_application_date['und'][0]['value']);?></div>
<div class="profile"<?php print $attributes; ?>>
    <h3>Welcome to your CAHPI Profile Page</h3>
    <p>On the top of the page you can see a number of Extranet links that are only available when you have logged into the site. The Articles section contains recent CAHPI news and articles on Home Inspection best practices. The calendar highlights
    ...
    <p>E & O insurance is a mandatory requirement for all CAHPI Inspectors. Please make sure you've completed this field in the "Certification" section.</p>
