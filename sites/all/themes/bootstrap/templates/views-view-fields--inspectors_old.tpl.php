...
?>
          <li class="span3">
            <div class="thumbnail thumbnail-1"> <?php print $fields['picture']->content; ?>
              <div class="caption"> <a href="#"><strong><?php print $fields['value_1']->content; ?></strong></a>
                <p>
                    <?php print $fields['value_3']->content; ?> <?php print $fields['value_4']->content; ?></br>
                    certification level: <?php print $fields['value']->content; ?><br/>
                    <?php if(strlen($fields['value_6']->content) > 0) print 'National Certification #: ' . $fields['value_6']->content . "</br>"; ?>
                    Ph: <?php print $fields['value_7']->content; ?> Fax: <?php print $fields['value_2']->content; ?></br>
                    <?php print $fields['mail']->content; ?></br>
                    <?php if(!empty($fields['value_9']->content) && !preg_match('/^\<a href=\"\"/',$fields['value_9']->content)) print $fields['value_9']->content; ?>
                </p>
              </div>
            </div>
          </li>
  ...
  <tr>
    <td><?php if(!empty($fields['value_9']->content)):?><a href="<?php print $fields['value_9']->content;?>" target="_blank" onclick="pageTracker._trackEvent('Website','Inspectors','<?php  print $fields['value_10']->content; ?>');">Company Website</a><?php endif;?></td>
  </tr>
  <tr>
